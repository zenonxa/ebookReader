...
#define FONT_SIZE_ALL                                                          \
    (FONT_SIZE_PX12 + FONT_SIZE_PX16 + FONT_SIZE_PX24 + FONT_SIZE_PX32)
...
/* Occupation of all of the FONT, including header, UniGBK.bin, and all kinds of
 * font library. */
