...
u8 mf_fmkfs(const u8* path, const MKFS_PARM* opt, void* work, UINT len)
{
	return f_mkfs((const TCHAR*)path, opt, work, len);//格式化,drv:盘符;mode:模式;au:簇大小
} 
