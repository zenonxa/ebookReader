...
void atk_md0700_fsmc_init(void)
{
    ...
    ATK_MD0700_FSMC_RD_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_WR_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D0_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D1_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D2_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D3_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D4_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D5_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D6_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D7_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D8_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D9_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D10_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D11_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D12_GPIO_CLK_ENABLE();
    ATK_MD0700_FSMC_D13_GPIO_CLK_ENABLE();
